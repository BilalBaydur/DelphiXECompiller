...
// (DO NOT EDIT: machine generated header) 'DSClientCreators.pas' rev: 22.00

#ifndef DsclientcreatorsHPP
#define DsclientcreatorsHPP
...
using namespace Dsclientcreators;
#endif
#pragma pack(pop)
#pragma option pop
