...
// (DO NOT EDIT: machine generated header) 'dipstudiowin.pas' rev: 22.00
...
#include <wwDBNavEdt.hpp>	// Pascal unit
#include <wwCollectionEditor.hpp>	// Pascal unit
#include <wwInspectorPrpEdt.hpp>	// Pascal unit
