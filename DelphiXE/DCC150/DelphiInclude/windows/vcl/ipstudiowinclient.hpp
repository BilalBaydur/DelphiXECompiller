...
// (DO NOT EDIT: machine generated header) 'ipstudiowinclient.pas' rev: 22.00

#ifndef IpstudiowinclientHPP
#define IpstudiowinclientHPP
...
#include <wwmidas.hpp>	// Pascal unit
#include <wwclient.hpp>	// Pascal unit
#include <wwProvider.hpp>	// Pascal unit
#include <Windows.hpp>	// Pascal unit
#include <ExcUtils.hpp>	// Pascal unit
...
#include <wwcheckbox.hpp>	// Pascal unit
...
using namespace Ipstudiowinclient;
#endif
#pragma pack(pop)
#pragma option pop
