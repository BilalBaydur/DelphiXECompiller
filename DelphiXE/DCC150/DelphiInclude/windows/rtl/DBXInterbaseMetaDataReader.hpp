...
// (DO NOT EDIT: machine generated header) 'DBXInterbaseMetaDataReader.pas' rev: 22.00

#ifndef DbxinterbasemetadatareaderHPP
#define DbxinterbasemetadatareaderHPP
...
class PASCALIMPLEMENTATION TDBXInterbaseCustomMetaDataReader : public Dbxmetadatareader::TDBXBaseMetaDataReader
{
	typedef Dbxmetadatareader::TDBXBaseMetaDataReader inherited;
	
public:
	__fastcall virtual ~TDBXInterbaseCustomMetaDataReader(void);
...
private:
	...
	#define TDBXInterbaseCustomMetaDataReader_DefaultStringStart L"DEFAULT "
	
	#define TDBXInterbaseCustomMetaDataReader_DefaultCharsetIsUnicode L"UnicodeEncoding"
	
	#define TDBXInterbaseCustomMetaDataReader_QuoteCharacterEnabled L"QuoteCharEnabled"
...
public:
	/* TObject.Create */ inline __fastcall TDBXInterbaseCustomMetaDataReader(void) : Dbxmetadatareader::TDBXBaseMetaDataReader() { }
...
public:
	/* TDBXInterbaseCustomMetaDataReader.Destroy */ inline __fastcall virtual ~TDBXInterbaseMetaDataReader(void) { }
	
public:
	/* TObject.Create */ inline __fastcall TDBXInterbaseMetaDataReader(void) : TDBXInterbaseCustomMetaDataReader() { }
	
};


class DELPHICLASS TDBXInterbaseTypeFilterCursor;
class PASCALIMPLEMENTATION TDBXInterbaseTypeFilterCursor : public Dbxmetadatareader::TDBXCustomMetaDataTable
{
...
public:
		...
		static const System::ShortInt FBlr_boolean_dtype = 0x11;
...
public:
	__fastcall virtual ~TDBXInterbaseTypeFilterCursor(void);
	virtual bool __fastcall Next(void);
	
protected:
	__fastcall TDBXInterbaseTypeFilterCursor(const TDBXInterbaseCustomMetaDataReader* Provider, const System::UnicodeString MetadataCollectionName, const Dbxcommon::TDBXValueTypeArray Columns, const Dbxcommontable::TDBXTable* Cursor, const int OrdinalTypeName, const int OrdinalFieldType, const int OrdinalSubType, const int OrdinalScale, const int OrdinalDefaultValue);
...
private:
	...
	#define TDBXInterbaseTypeFilterCursor_DefaultStringStart L"DEFAULT "
...
using namespace Dbxinterbasemetadatareader;
#endif
#pragma pack(pop)
#pragma option pop
...
//-- end unit ----------------------------------------------------------------
#endif	// DbxinterbasemetadatareaderHPP
